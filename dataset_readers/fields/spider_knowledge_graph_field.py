...
from dataset_readers.fields.knowledge_graph_field import KnowledgeGraphField
...
class SpiderKnowledgeGraphField(KnowledgeGraphField):
    ...
    def __init__(
        ...
        self.linking_features = self._compute_related_linking_features(
    ...
    def _compute_related_linking_features(
        self, non_related_features: List[List[List[float]]]
