...
GRAMMAR_DICTIONARY["join_clause"] = [
    '"join" ws table_source ws "on" ws join_condition_clause'
]
GRAMMAR_DICTIONARY["join_condition_clause"] = [
    '(join_condition ws "and" ws join_condition_clause)',
    "join_condition",
]
GRAMMAR_DICTIONARY["join_condition"] = ['ws col_ref ws "=" ws col_ref']
GRAMMAR_DICTIONARY["source"] = [
    '(ws single_source ws "," ws source)',
    "(ws single_source)",
]
...
GRAMMAR_DICTIONARY["where_conj"] = [
    '(ws "and" wsp expr ws where_conj)',
    '(ws "and" wsp expr)',
]
...
GRAMMAR_DICTIONARY["order_clause"] = [
    '(ordering_term ws "," ws order_clause)',
    "ordering_term",
]
...
def update_grammar_with_tables(
    grammar_dictionary: Dict[str, List[str]], schema: Dict[str, Table]
) -> None:
    table_names = sorted(
        [f'"{table.lower()}"' for table in list(schema.keys())], reverse=True
    )
...
def update_grammar_flip_joins(grammar_dictionary: Dict[str, List[str]]):
    ...
    grammar_dictionary["join_clauses"] = [
        "(join_clauses_1 ws join_clause)",
        "join_clause",
    ]
    grammar_dictionary["join_clauses_1"] = [
        "(join_clauses_2 ws join_clause)",
        "join_clause",
    ]
    grammar_dictionary["join_clauses_2"] = [
        "(join_clause ws join_clause)",
        "join_clause",
    ]
