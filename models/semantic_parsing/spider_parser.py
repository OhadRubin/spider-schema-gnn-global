...
class SpiderParser(Model):
    def __init__(self,
        ...
        # self._gnn_encoder = GNNEncoder(self._embedding_dim, gnn_timesteps, num_edge_types=3, dropout=dropout)
        ...
        if gnn:
            encoder_output_dim = action_embedding_dim+encoder.get_output_dim()
        else:
